    ...
    <div className="museum-container">
      ...
      {filtered.length === 0 ? (
        <div className="museum-no-results">
          <p>
            No museums found for "<strong>{query}</strong>"
          </p>
          <button
            onClick={() => {
              setQuery("");
            ...
            <div key={museum.id} className="museum-card">
              <div className="museum-img-wrapper">
                ...
                <button
                  ...
                  aria-label={
                    favorites[museum.id]
                      ? `Remove ${museum.name} from favorites`
                      : `Save ${museum.name} to favorites`
                  }
                >
                  <FaHeart />
                </button>
              ...
              <div className="museum-details">
                <div>
                  <div className="museum-top-row">
                    ...
                    <div
                      className="museum-rating"
                      aria-label={`Rated ${museum.rating}`}
                    >
