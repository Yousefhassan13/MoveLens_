...
const cornicheData = [
  { id: 1, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg1, tag: 'Recommended' },
  { id: 2, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg2, tag: 'Recommended' },
  { id: 3, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg3, tag: '' },
  { id: 4, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg4, tag: 'Recommended' },
  { id: 5, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg5, tag: 'Recommended' },
  { id: 6, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg6, tag: 'Most Visited' },
  { id: 7, name: 'Promenades',  location: 'Giza', rating: '4.5', discount: '10% Off', price: '200 EGP', image: cornicheImg7, tag: '' },
];
...
export default function CornichePage() {
  ...
  // ✅ فلترة حقيقية بناءً على الـ tab والـ search
          ...
          {filtered.map((item) => (
            <div key={item.id} className="corniche-card">
              <div className="corniche-img-wrapper">
                <img src={item.image} alt={item.name} className="corniche-card-img" />
                {/* ✅ زر المفضلة متفاعل */}
                <button
                  className={`corniche-fav-btn ${favorites[item.id] ? 'active' : ''}`}
                  onClick={() => toggleFavorite(item.id)}
                  aria-label={favorites[item.id] ? `Remove ${item.name} from favorites` : `Save ${item.name} to favorites`}
                >
                  <FaHeart />
                </button>
              </div>
              ...
              <div className="corniche-details">
                <div>
                  <div className="corniche-top-row">
                    ...
                    <div className="corniche-rating" aria-label={`Rated ${item.rating} out of 5`}>
