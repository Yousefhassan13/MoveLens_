            ...
            <div key={mall.id} className="shopping-card">
              <div className="shopping-img-wrapper">
                ...
                />
                  ...
                  aria-label={
                    favorites[mall.id]
                      ? `Remove ${mall.name} from favorites`
                      : `Save ${mall.name} to favorites`
                  }
                >
                  <FaHeart />
                </button>
              ...
              <div className="shopping-details">
                <div>
                  <div className="shopping-top-row">
                    ...
                    <div
                      className="shopping-rating"
                      aria-label={`Rated ${mall.rating} out of 5`}
                    >
                ...
                <div className="shopping-bottom-row">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate("/shopping-details", { state: { place: mall } })
                    } 
                  >
                    <FiChevronRight />
                  </button>
